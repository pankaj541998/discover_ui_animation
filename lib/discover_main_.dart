...
class Discovers extends StatefulWidget {
  ...
  @override
  State<Discovers> createState() => _DiscoversState();
}

class _DiscoversState extends State<Discovers> {
  List<String> images = [
                      ...
                      StaggeredGridView.countBuilder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () => zoomInFunction(images[index]),
                            child: FadeInUp(
                        ...
                        staggeredTileBuilder: (index) =>
                            StaggeredTile.count(2, index.isEven ? 3 : 3.6 / 2),
                      ),
                      Center(),
                      Center(),
                      Center(),
